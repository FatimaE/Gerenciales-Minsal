...
class PruebaConController extends Controller
{
    ...
    { //para obtener los datos de la carrera como de la institución 
           ...
           /*    //Recuperar el id de ss_carrera_inst 
            ...
            return $this->render('minsalSIGminsalSIGBundle:Tactico:pruebaCon.html.twig', array('form' => $form->createView(), 'carrera' => $carrera, 'universidad' => $universidad,));
     ...
     public function todosAction(Request $request)
    {
        ...
        $universidad=$repository->getRepository('minsalSIGminsalSIGBundle:SsInstitucionFormadora')->findAll();
         ...
         return $this->render('minsalSIGminsalSIGBundle:Tactico:RepPruebaCon.html.twig', array('universidad' => $universidad));   
