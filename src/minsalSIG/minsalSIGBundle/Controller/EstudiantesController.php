        ...
        if ($form->isValid()) {
            ...
            if($c_Id == 0){
                ...
                if($u_Id == 0){                                                   
                    ...
                    $resultado = $conn->fetchAll('SELECT ci.id, ci.id_carrera, ci.id_institucion_formadora, count(e.id) total
                    ...
                    return $this->render('minsalSIGminsalSIGBundle:Estrategico:estudiantes1.html.twig', array('carreras' => $carreras, 'universidades' => $universidad, 'resultados'=>$resultado));                                                                                     
                }
                else 
                   //Seleccionar todas carreras, una universidad
                    if($u_Id != 0){
                        ...
                        return $this->render('minsalSIGminsalSIGBundle:Estrategico:estudiantes2.html.twig', array('carreras' => $carreras, 'universidad' => $universidadId, 'resultados'=>$resultado)); 
                    }
            }
            //Selecciona una carrera
                ...
                if($c_Id != 0){
                    ...
                    if($u_Id == 0){
                        ...
                        return $this->render('minsalSIGminsalSIGBundle:Estrategico:estudiantes3.html.twig', array('carrera' => $carreraId, 'universidades' => $universidad, 'resultados'=>$resultado)); 
                    }
                        ...
                        if($u_Id != 0){  
                            ...
                            return $this->render('minsalSIGminsalSIGBundle:Estrategico:estudiantes4.html.twig', array('carrera' => $carreraId, 'universidad' => $universidadId, 'resultados'=>$resultado)); 
                        }
                }        
        }
             
             
             return $this->render('minsalSIGminsalSIGBundle:Estrategico:estudiantes.html.twig', array('form' => $form->createView()));
